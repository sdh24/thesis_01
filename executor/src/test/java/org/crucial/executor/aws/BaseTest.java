...
public class BaseTest extends AbstractTest {
	 ...
	 * 
	 * ExecutorService service = new AWSLambdaExecutorService(); Future<Integer>
	 * future = service.submit((Serializable & Callable<Integer>) () -> { return 1;
	 * }); assert future.get() == 1; }
	 * 
	 * public void multipleTest() throws InterruptedException, ExecutionException {
	 * ExecutorService service = new AWSLambdaExecutorService();
	 * List<Future<Integer>> l = service.invokeAll(
	 * IntStream.range(0,100).mapToObj(n -> (Serializable & Callable<Integer>) () ->
	 * { return 1; }).collect(Collectors.toList())); int count = 0; for
	 * (Future<Integer> f: l) {count+=f.get();} assert count == 100; }
	 */
